<?php
/**
 * Proxy PHP para Landing Page /gentehub
 * Gente Networking
 * 
 * Este script faz proxy reverso server-side para a landing page hospedada
 * no Cloudflare Pages, mantendo a URL original gentenetworking.com.br/gentehub
 * 
 * Compatível com pixels de rastreamento (Meta Ads, Google Ads, etc.)
 */

// Configurações
$target_url = 'https://lps.gentenetworking.com.br/gentehub';
$base_domain = 'https://lps.gentenetworking.com.br';

// Capturar o caminho adicional (ex: /gentehub/teste)
$request_uri = $_SERVER['REQUEST_URI'];
$path = str_replace('/gentehub', '', parse_url($request_uri, PHP_URL_PATH));
...
$body = str_replace('href="/', 'href="/gentehub/', $body);
$body = str_replace('src="/', 'src="/gentehub/', $body);

// Ajustar URLs absolutas do Cloudflare Pages
$body = str_replace('https://lps.gentenetworking.com.br/', '/gentehub/', $body);
